    ...
    <div class="content">
            <div id="brad">
                ...
                <form action="home.html" method="post">
                        ...
                        <div id="input">
                            <input type="text" id="prenom" placeholder="surname"  name="prenom"  required>
                        </div>
                        <div id="input">
                            <input type="password" name="motdepass" id="motdepasse" placeholder="password"  required>
                        </div>
                            <div>
                ...
                <div>
                    <img src="images/image gif.png" alt="image gif" width="130">
                </div>
            </div>
